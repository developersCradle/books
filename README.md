<p align="center">
    <img id="studying" src="studying desc.png" style="height: 500px; width: 800px;">
...
<p align="center">
    <img id="pro git" src="proGit.png" style=" width: 300px;">
</p>

#### Progress/Curriculum.

- [x] [Section 01](#) - Chapters here from the book!
- [x] [Section 02 - Git Basics](#)
- [x] [Section 03 - Git Branching](#)
- [x] [Section 04 - Git on the Server](#)
- [x] [Section 05 - Distributed Git](#)
- [x] [Section 06 - GitHub](#)
- [x] [Section 07 - Git Tools](#)
- [x] [Section 08 - Customizing Git](#)
- [x] [Section 09 - Git and Other Systems](#)
- [x] [Section 10 - Git Internals](#)

#### Additional stuff.

- [x] All over the web, or example this one. [Source](https://git-scm.com/book/en/v2)! ✅

<p align="center">
    <img id="design patters" src="DesignPattersGof.JPG" style="width: 300px;">
</p>
...
- [x] All over the web, or example this one. [Source](https://www.javier8a.com/itc/bd1/articulo.pdf)! ✅
